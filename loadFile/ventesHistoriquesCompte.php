...
$listcommandeshisto = CommandeAchat::cmdHistoForCpt($_SESSION['idCptVend'], $datedeb, $datefin);

?>

<h3 style="text-align: center;">Liste des Commandes Historiques Par compte</h3>
<table class="table table-striped table-bordered table-hover" id="listcommandeshisto">
    <thead>
        <tr class="th_color">
    ...
    <tbody>
        <?php
        foreach ($listcommandeshisto as $line) {

            if ($line['etatLivCom'] == 3)
                $etat = "Livrée";
            else
                $etat = "Annuler";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //Edit de compte
        historiccommandes = setupDataTables("listcommandeshisto", {
            dom: 'Bfrtip',
            "columnDefs": [{
                sortable: false,
                orderable: false,
