...
<body>
    <div data-role="page" id="seul-page" class="jqm-demos ui-responsive-panel">
        <div data-role="panel" data-position-fixed="true" id="mypanel" data-dismissible="false">
            ...
            ?>
            <div class="copy-right" style="position: fixed; bottom:1vh;">
                <p> &copy; 2023 Admin <a href="https://topcosmetics.dstech.solutions"><span style="">TopCosmetics</span></a></p>
            </div>
        </div><!-- /panel -->
        <div data-role="header" data-theme="e" data-position="fixed" role="banner" id="top-header">
...
<style>
    ...
    #seul-page h1 .ui-body-c,
    #seul-page h1 .ui-btn-down-c,
    #seul-page h1 .ui-btn-hover-c,
    #seul-page h1 .ui-btn-up-c,
    #seul-page h1 .ui-overlay-c {
        text-shadow: 0 1px 0 #000;
    }

    #seul-page h1 .ui-bar-e,
    #seul-page h1 .ui-body-e,
    #seul-page h1 .ui-overlay-e {
        text-shadow: 0 1px 0 #000;
    }
</style>
