...
<div data-role="page" id="standard" data-add-back-btn="true">
  ...
  <div data-role="content">
	<form method="post" action="" id="deleteuser" style="margin:10px 20px;">
            <div id="messageBox">
        ...
        <script type="text/javascript">
            $(function(){
                $("#deletesubmit").on('click', function(){
                    ...
                    params = $("#deleteuser").serialize();
                    $('#messageBox').hide('slow');
                    AjaxLoader("deleteUser.php", params + '&submit=yes', $('#deleteuser .messageBox'), '#content','users.php');
